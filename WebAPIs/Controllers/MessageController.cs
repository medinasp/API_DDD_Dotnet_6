...
namespace WebAPIs.Controllers
{
    ...
    public class MessageController : ControllerBase
    {
        ...
        public async Task<List<Notifies>> Add(MessageViewModel message)
        {
            ...
            //transforma a viewmodel na model com o MAP
            var messageMap = _IMapper.Map<Message>(message);
            //envia para a interface chamar o método de inserir no banco
        ...
        //método para chamar interface genérica IMessage para listar todas mensagens
        //[Authorize]   
        [AllowAnonymous]
        [Produces("application/json")]
        [HttpPost("/api/List")]
        ...
        //método para chamar interface específica do serviço para listar só mensagens ativas
        [Authorize]
        [Produces("application/json")]
